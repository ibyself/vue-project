    ...
    <div>
        <div class="shopcart">
            ...
            <div class="content-left">
                ...
                <div class="logo" @click="toggleCartShow" :class="{highlight:totalCount}">
            ...
            <transition name="fade">
                <div class="shopcart-list"  v-show="isShowCart">
                    ...
                    <div class="list-content">
                        <ul>
                            <li class="food" v-for="(food,index) in cartDatas" :key="index">
        ...
        <div @click="isShowCart=false" class="list-mask" v-show="isShowCart"></div>
    </div>
...
<script  type="text/ecmascript-6">
    ...
    export default {
        ...
        methods:{
            ...
            clearCart(){
                MessageBox.confirm("确定清空吗?").then(active=>{
        ...
        computed:{
            ...
            ...mapState({
                ...
                cartDatas:state=>state.shop.cartDatas
            }),
            payText(){
                ...
                if(totalPrice===0){
                    ...
                    text=`还差${info.minPrice-totalPrice}元起送`
                }else{
                    text='去结算'
                }
                return text
